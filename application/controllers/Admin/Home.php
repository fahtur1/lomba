            ...
            case "PC2000-8":
                ...
                if ($this->input->post()) :
                    ...
                    elseif ($ps == 'PS3' || $ps == 'PS4') :
                        ...
                        if ($this->Pc2000_model->insertPs3($data, $actual_data, $other)) {
                            $this->flask('success', 'Actual Plan added Succesfuly', 'message');
                        } else {
                            $this->flask('danger', 'Failed to add Actual Plan', 'message');
                        }
                ...
                case "PS4":
                    ...
                    switch ($unit) {
                        case "PC2000-8":
                            ...
                            if ($this->Pc2000_model->insertPs34($data, $other, $actual_data)) {
                                redirect('/admin/home/dashboard');
                            } else {
                                echo "gagal";
                            }
                        ...
                        case "HD785-7":
                            ...
                            if ($this->Hd7857_model->insertPs34($data, $other, $actual_data)) {
                                redirect('/admin/home/dashboard');
                            } else {
                                echo "gagal";
                            }
...
>>>>>>> 0b043223ed626af8d1791b9ac4ca483a2b2e8e3b
                    break;
                else :
                    $this->load->view('templates/sidebar');
